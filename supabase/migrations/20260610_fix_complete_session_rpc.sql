-- Fix: complete_workout_session was missing gym_id in workout_sessions INSERT
-- The 20260601_cardio_metrics migration overwrote the RPC and lost the gym_id
-- field that was added in 20260524_harden_multi_tenant_schema.
