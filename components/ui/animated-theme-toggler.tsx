...
export function AnimatedThemeToggler({ sound = true }: AnimatedThemeTogglerProps) {
  ...
  const spring = isFirst.current || prefersReduced
    ? { duration: 0 }
  ...
  return (
    <motion.button
      ...
      className="h-9 w-9 rounded-full border border-zinc-200 bg-zinc-100 text-zinc-500 hover:bg-zinc-200 hover:text-zinc-900 dark:border-zinc-700 dark:bg-zinc-800/60 dark:text-zinc-400 dark:hover:bg-zinc-700 dark:hover:text-zinc-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500"
